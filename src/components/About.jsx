...
function About() {
  return (
    <section className="container mx-auto mb-8" id="about">
        <h2 className='mb-8 text-center text3xl tracking-tighter lg:text-4xl'>About Us</h2>
        <div className='flex flex-wrap '>
            ...
            <motion.p
                  ...
                  whileInView={{opacity:1, y:0}}
                  viewport = {{once: true}}
                  transition={{duration: 0.6, delay: 0.6}} className='m-8 text-2xl leading-relaxed tracking-tight 
            lg:max-w-xl '>{ABOUT.content}</motion.p>
            </div>
